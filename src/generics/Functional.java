...
public class Functional {
	// Calls the Combiner object on each element to combiine
	...
	// and returns a list of items that prduced "true"
	...
	// function objects to adapts to our particular needs
	...
	static class AtomicLongAdder implements Combiner<AtomicLong> {
		public AtomicLong combine(AtomicLong x, AtomicLong y) {
			// Not clear whether is this is meaningful
